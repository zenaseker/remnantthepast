...
namespace TMPro.Examples
{
    ...
    public class TMP_TextInfoDebugTool : MonoBehaviour
    {
        ...
        void OnDrawGizmos()
        {
            ...
            // GetClass a reference to the text object's textInfo
            m_TextInfo = m_TextComponent.textInfo;

            // UpdateAction Text Statistics
            ...
            // GetClass the handle size for drawing the various
        ...
        void DrawCharactersBounds()
        {
            ...
            for (int i = 0; i < characterCount; i++)
            {
                ...
                // GetClass Bottom Left and Top Right position of the current character
        ...
        void DrawBounds()
        {
            ...
            // GetClass Bottom Left and Top Right position of each word
